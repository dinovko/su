  ...
  return (
    <Box sx={{ width: '100%' }}>
      ...
      <CustomTabPanel key={'supply-form-1'} value={value} index={0}>
        <SupplyForm1 key={'supply-form-1'} />
      </CustomTabPanel>
      <CustomTabPanel key={'supply-form-2'} value={value} index={1}>
        <SupplyForm2 key={'supply-form-2'} />
      </CustomTabPanel>
      <CustomTabPanel key={'supply-form-3'} value={value} index={2}>
        <SupplyForm3 key={'supply-form-3'} />
      </CustomTabPanel>
      <CustomTabPanel key={'supply-form-4'} value={value} index={3}>
        <SupplyForm4 key={'supply-form-4'} />
      </CustomTabPanel>
