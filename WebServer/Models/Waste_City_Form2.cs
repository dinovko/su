...
namespace WebServer.Models
{
    public class Waste_City_Form2 : Base
    {
        ...
        public bool? IsConnectedToCentralizedWastewaterSystem { get; set; } = false;

        [Comment("Наличие канализационно-очистных сооружений, (1-0)")]
        public bool? HasSewageTreatmentFacilities { get; set; } = false;

        [Comment("С механичес-кой очисткой (1-0)")]
        public bool? HasMechanicalTreatment { get; set; } = false;

        [Comment("С механической и биологической очист-кой (1-0)")]
        public bool? HasMechanicalAndBiologicalTreatment { get; set; } = false;
